...
class Player:
    ...
    def update_distance(self, dis):
        ...
        # ya que comparo la distancia recorrida en cada frame 0, hasta el siguiente batch falta un segundo con lo que la velocidad es en cm/s 
